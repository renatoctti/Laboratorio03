...
public class DemoApplication {
    ...
    public CommandLineRunner demoData(
        ...
        return (args) -> {
            ...
            // --- Professores ---
            // Professor 1 (com o email real fornecido)
            if (usuarioService.buscarUsuarioPorEmail("lucasflorvilela13@gmail.com") == null) {
                Professor profAna = new Professor();
                profAna.setEmail("lucasflorvilela13@gmail.com"); // Email real para teste
                profAna.setSenha("senha123"); // Senha em texto puro, conforme sua instrução
                profAna.setRole("PROFESSOR");
                profAna.setNome("Lucas Vilela");
                ...
                usuarioService.cadastrarProfessor(profAna);
            }
            ...
            if (usuarioService.buscarUsuarioPorEmail("prof.breno@puc.com") == null) {
                ...
                usuarioService.cadastrarProfessor(profBreno);
            }
            ...
            if (usuarioService.buscarUsuarioPorEmail("prof.carla@newton.com") == null) {
                ...
                usuarioService.cadastrarProfessor(profCarla);
            }
        };
    }
}
